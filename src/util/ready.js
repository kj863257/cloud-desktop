...
//浏览器检测相关对象，在此为节省代码未实现，实际使用时需要实现。
        var Browser = {};
        (!!window.ActiveXObject || "ActiveXObject" in window)?Browser['ie']=1
            :(navigator.userAgent.indexOf("Firefox")>0)?(Browser['ff']=1,Browser['version']=/firefox\/[\d.]+/gi.exec(navigator.userAgent)[0]):'';
